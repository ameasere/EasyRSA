...
class Ui_TwoFactorWindow(object):
    def setupUi(self, TwoFactorWindow):
        if not TwoFactorWindow.objectName():
            TwoFactorWindow.setObjectName(u"TwoFactorWindow")
        TwoFactorWindow.resize(764, 765)
        TwoFactorWindow.setMinimumSize(QSize(500, 400))
        icon = QIcon()
        icon.addFile(u":/images/images/images/RSA.png", QSize(), QIcon.Normal, QIcon.Off)
        TwoFactorWindow.setWindowIcon(icon)
        self.styleSheet = QWidget(TwoFactorWindow)
...
"background-repeat: no-repeat;")
        ...
        self.logintitle.setGeometry(QRect(0, 0, 651, 41))
        ...
        self.confirmButton.setGeometry(QRect(480, 480, 150, 30))
...
"color: rgb(240, 38, 24);")
        ...
        self.qrFrame = QFrame(self.home)
        self.qrFrame.setObjectName(u"qrFrame")
        self.qrFrame.setGeometry(QRect(140, 70, 381, 381))
        self.qrFrame.setFrameShape(QFrame.StyledPanel)
        self.qrFrame.setFrameShadow(QFrame.Raised)
        self.qrcode = QLabel(self.qrFrame)
        self.qrcode.setObjectName(u"qrcode")
        self.qrcode.setGeometry(QRect(0, 0, 381, 381))
        ...
        self.dashboardTitle_2.setGeometry(QRect(10, 470, 441, 51))
        self.dashboardTitle_2.setStyleSheet(u"font: 63 10pt \"Raleway SemiBold\";\n"
"color: rgb(170, 99, 255)")
        ...
        self.codebox = QLineEdit(self.home)
        self.codebox.setObjectName(u"codebox")
        self.codebox.setGeometry(QRect(20, 530, 221, 30))
...
"color: rgb(170, 99, 255)")
        self.announceBox = QLabel(self.home)
        self.announceBox.setObjectName(u"announceBox")
        self.announceBox.setGeometry(QRect(50, 590, 561, 31))
...
"font: 81 10pt \"Raleway ExtraBold\";")
        ...
        TwoFactorWindow.setCentralWidget(self.styleSheet)

        self.retranslateUi(TwoFactorWindow)

        self.stackedWidget.setCurrentIndex(0)


        QMetaObject.connectSlotsByName(TwoFactorWindow)
    # setupUi

    def retranslateUi(self, TwoFactorWindow):
        TwoFactorWindow.setWindowTitle(QCoreApplication.translate("TwoFactorWindow", u"EasyRSA", None))
        self.titleRightInfo.setText(QCoreApplication.translate("TwoFactorWindow", u"EasyRSA", None))
#if QT_CONFIG(tooltip)
        self.minimizeAppBtn.setToolTip(QCoreApplication.translate("TwoFactorWindow", u"Minimize", None))
#endif // QT_CONFIG(tooltip)
        self.minimizeAppBtn.setText("")
#if QT_CONFIG(tooltip)
        self.maximizeRestoreAppBtn.setToolTip(QCoreApplication.translate("TwoFactorWindow", u"Maximize", None))
#endif // QT_CONFIG(tooltip)
        self.maximizeRestoreAppBtn.setText("")
#if QT_CONFIG(tooltip)
        self.closeAppBtn.setToolTip(QCoreApplication.translate("TwoFactorWindow", u"Close", None))
#endif // QT_CONFIG(tooltip)
        self.closeAppBtn.setText("")
        self.logintitle.setText(QCoreApplication.translate("TwoFactorWindow", u"2 Factor Authentication", None))
        self.confirmButton.setText(QCoreApplication.translate("TwoFactorWindow", u"I have!", None))
        self.responseTitle.setText("")
        self.qrcode.setText("")
        self.dashboardTitle_2.setText(QCoreApplication.translate("TwoFactorWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">Scan this QR code in your authenticator app, like Authy or Google Authenticator. Do not share this with anyone!</span></p></body></html>", None))
        self.codebox.setText("")
        self.codebox.setPlaceholderText(QCoreApplication.translate("TwoFactorWindow", u"...", None))
