...
"background-repeat: no-repeat;")
    ...
    def retranslateUi(self, ConfirmDeleteWindow):
        ...
        self.version.setText(QCoreApplication.translate("ConfirmDeleteWindow", u"<html><head/><body><p><span style=\" font-weight:600;\">Development Build</span> v0.0.9</p></body></html>", None))
    # retranslateUi
