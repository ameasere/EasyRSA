...
class Ui_ConfirmDeleteWindow(object):
    def setupUi(self, ConfirmDeleteWindow):
        if not ConfirmDeleteWindow.objectName():
            ConfirmDeleteWindow.setObjectName(u"ConfirmDeleteWindow")
        ConfirmDeleteWindow.resize(500, 400)
        ConfirmDeleteWindow.setMinimumSize(QSize(500, 400))
        icon = QIcon()
        icon.addFile(u":/images/images/images/RSA.png", QSize(), QIcon.Normal, QIcon.Off)
        ConfirmDeleteWindow.setWindowIcon(icon)
        ConfirmDeleteWindow.setStyleSheet(u"")
        self.styleSheet = QWidget(ConfirmDeleteWindow)
...
"background-repeat: no-repeat;")
        ...
        self.usertitle_2.setFont(font3)
...
"font: 63 10pt \"Raleway SemiBold\";")
        ...
        ConfirmDeleteWindow.setCentralWidget(self.styleSheet)
        ...
        QMetaObject.connectSlotsByName(ConfirmDeleteWindow)
    # setupUi
    ...
    def retranslateUi(self, ConfirmDeleteWindow):
...
#if QT_CONFIG(tooltip)
        self.maximizeRestoreAppBtn.setToolTip(QCoreApplication.translate("ConfirmDeleteWindow", u"Maximize", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.creditsLabel.setText(QCoreApplication.translate("ConfirmDeleteWindow", u"<html><head/><body><p><span style=\" color:#ffffff;\">Group 1</span></p></body></html>", None))
        self.version.setText(QCoreApplication.translate("ConfirmDeleteWindow", u"<html><head/><body><p><span style=\" font-weight:600; color:#ffffff;\">Version</span><span style=\" color:#ffffff;\"> 0.0.5</span></p></body></html>", None))
    # retranslateUi
