...
"color: rgb(240, 38, 24);")
        ...
        self.openFilepathButton.setGeometry(QRect(80, 150, 150, 30))
    ...
    def retranslateUi(self, MoveWindow):
        ...
        self.titleRightInfo.setText(QCoreApplication.translate("MoveWindow", u"EasyRSA", None))
        ...
        self.logintitle.setText(QCoreApplication.translate("MoveWindow", u"Move", None))
        self.usertitle.setText(QCoreApplication.translate("MoveWindow", u"Select a folder to move this file to:", None))
        ...
        self.version.setText(QCoreApplication.translate("MoveWindow", u"<html><head/><body><p><span style=\" font-weight:600;\">Version</span> 0.0.1</p></body></html>", None))
    # retranslateUi
