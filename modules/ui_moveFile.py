...
class Ui_MoveWindow(object):
    ...
    def retranslateUi(self, MoveWindow):
        MoveWindow.setWindowTitle(
            QCoreApplication.translate(
                "MoveWindow", u"EasyRSA", None))
