...
"background-repeat: no-repeat;")
    ...
    def retranslateUi(self, RegenerateKeysWindow):
        ...
        self.creditsLabel.setText(QCoreApplication.translate("RegenerateKeysWindow", u"By: enigmapr0ject", None))
        self.version.setText(QCoreApplication.translate("RegenerateKeysWindow", u"<html><head/><body><p><span style=\" font-weight:600;\">Version</span> 0.0.4</p></body></html>", None))
    # retranslateUi
