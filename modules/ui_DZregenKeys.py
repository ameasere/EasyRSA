...
class Ui_RegenerateKeysWindow(object):
    def setupUi(self, RegenerateKeysWindow):
        if not RegenerateKeysWindow.objectName():
            RegenerateKeysWindow.setObjectName(u"RegenerateKeysWindow")
        RegenerateKeysWindow.resize(500, 400)
        RegenerateKeysWindow.setMinimumSize(QSize(500, 400))
        icon = QIcon()
        icon.addFile(u":/images/images/images/RSA.png", QSize(), QIcon.Normal, QIcon.Off)
        RegenerateKeysWindow.setWindowIcon(icon)
        self.styleSheet = QWidget(RegenerateKeysWindow)
...
"background-repeat: no-repeat;")
        ...
        self.usertitle.setGeometry(QRect(0, 40, 391, 91))
...
"font: 63 10pt \"Raleway SemiBold\";")
        ...
        self.usertitle_2.setGeometry(QRect(0, 260, 161, 21))
        ...
        self.usertitle_2.setFont(font1)
        self.usertitle_2.setStyleSheet(u"font: 81 10pt \"Raleway ExtraBold\";")
        ...
        RegenerateKeysWindow.setCentralWidget(self.styleSheet)

        self.retranslateUi(RegenerateKeysWindow)

        self.stackedWidget.setCurrentIndex(0)


        QMetaObject.connectSlotsByName(RegenerateKeysWindow)
    # setupUi

    def retranslateUi(self, RegenerateKeysWindow):
        RegenerateKeysWindow.setWindowTitle(QCoreApplication.translate("RegenerateKeysWindow", u"EasyRSA", None))
        self.titleRightInfo.setText(QCoreApplication.translate("RegenerateKeysWindow", u"EasyRSA", None))
#if QT_CONFIG(tooltip)
        self.minimizeAppBtn.setToolTip(QCoreApplication.translate("RegenerateKeysWindow", u"Minimize", None))
#endif // QT_CONFIG(tooltip)
        self.minimizeAppBtn.setText("")
#if QT_CONFIG(tooltip)
        self.maximizeRestoreAppBtn.setToolTip(QCoreApplication.translate("RegenerateKeysWindow", u"Maximize", None))
#endif // QT_CONFIG(tooltip)
        self.maximizeRestoreAppBtn.setText("")
#if QT_CONFIG(tooltip)
        self.closeAppBtn.setToolTip(QCoreApplication.translate("RegenerateKeysWindow", u"Close", None))
#endif // QT_CONFIG(tooltip)
        self.closeAppBtn.setText("")
        self.logintitle.setText(QCoreApplication.translate("RegenerateKeysWindow", u"Regenerate Keys", None))
        self.usertitle.setText(QCoreApplication.translate("RegenerateKeysWindow", u"<html><head/><body><p>Are you sure? If you have data still encrypted, regenerating keys will render this data <span style=\" color:#ff0000;\">irrecoverable</span>!</p></body></html>", None))
        self.yesButton.setText(QCoreApplication.translate("RegenerateKeysWindow", u"Yes", None))
        self.noButton.setText(QCoreApplication.translate("RegenerateKeysWindow", u"No", None))
